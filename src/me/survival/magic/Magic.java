...
public enum Magic {
	...
	AKBAR(MagicType.ELITE, "Rage QUIT!", 450, Material.TNT, 0, Arrays.asList("§7Du wirst bei dieser", "§7Magie dich selbst in die" ,"§7luft jagen.(GEHT NOCH NICHT)", "§3Mana: §730"), "me.survival.magic.magics.Akbar", 9, 9),
